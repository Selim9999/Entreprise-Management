...
public class AddDirecteurCrudController implements Initializable {
    ...
    @FXML
    void addDirecteur(ActionEvent event) {
        DirecteurController ConnectNow = new DirecteurController();
        Connection connectDB = ConnectNow.getConnetion();

        String query = "INSERT INTO directeur VALUES (" + idTextField.getText() + ",'" + nomTextField.getText() + "','" + prenomTextField.getText() + "','" + salaireTextField.getText() + "'," + primeTextField.getText() + ")";
